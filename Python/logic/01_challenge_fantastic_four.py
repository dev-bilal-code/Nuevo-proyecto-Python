...
Objetivo: Crea una función en Python que reciba una cadena de texto. Esta función debe contar cuántas veces aparece la letra R (para Reed Richards) y cuántas veces aparece la letra J (para Johnny Storm) en la cadena.
...
def check_is_balanced(text):
  ...
  Cuenta_Richar = text.count("R") # cuenta el numero de veces que aparece la letra R
  cuenta_Johne = text.count("J")


  print(f"Cuenta_Richar: {Cuenta_Richar} : cuenta_Johne {cuenta_Johne}")

  return Cuenta_Richar  == cuenta_Johne

print (check_is_balanced("RR"))
print (check_is_balanced("JJ"))
print (check_is_balanced("JRRJ"))
print (check_is_balanced("RJRJ"))
print (check_is_balanced("AOQKAOOK"))
